...
public class Laboratorio extends javax.swing.JFrame {
 ...
 private static Principal principalRef;
  ...
  private int idAula = 2;
 
    public Laboratorio(Principal principalRef, int idProfesor) {
...
private boolean existeReserva(int idAula, java.sql.Date fechaReserva, Time horaInicio, Time horaFin) {
    ...
    try {
        ...
        java.util.Date maxHour = sdf.parse("14:31");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laboratorio(principalRef,idProfesor).setVisible(true);
            }
        });
    }
